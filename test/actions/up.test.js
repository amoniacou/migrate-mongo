...
describe('up', () => {
  ...
  function mockStatus() {
    return sinon.stub().returns(
      Promise.resolve([
        ...
        {
          fileName: '20160606093207-first_pending_migration.js',
          appliedAt: 'PENDING',
        },
        {
          fileName: '20160607173840-second_applied_migration.js',
          appliedAt: new Date(),
        },
        {
  ...
  function mockMigrationsDir() {
    ...
    mock.loadMigration
      .withArgs('20160606093207-first_pending_migration.js')
  ...
  it('should load all the pending migrations', async () => {
    ...
    expect(migrationsDir.loadMigration.getCall(0).args[0]).to.equal(
      '20160606093207-first_pending_migration.js'
    );
